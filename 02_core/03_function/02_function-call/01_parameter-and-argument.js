...
hello(1,2,3,4,5,6);
// hello 에 많은 값을 입력했을 경우,
// 1) console.log(name); -> 1 로 출력 : 10이 삭제되고 1이 출력됨. 
// 2) console.log(argumnets); -> argument 에는 모든 인수가 보관되어 0부터 하나하나 맵핑되어 출력된다. 

hello();
console.log(result);

console.log("여기서 끊어봅시다");
...
console.log(result);
// 함수 10이 홍길동으로 바뀌고, Argument에 할당되고, name 에 할당됨!!!

// 함수는 매개변수의 개수와 인수의 개수가 일치하는지 체크하지 않는다.
// 인수가 부족해서 할당되지 않은 매개변수의 값은 undefined이다.
console.log("여기서 끊어봅시다222222222");
result = hello();
console.log(result);
