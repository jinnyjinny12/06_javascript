...
console.log(`10 + 20 : ${10 + 20}`); // ${30} 이 나온다.
...
// 1) '' 빈 문자열 2) + 위해 {} 문자열로 변형됨. 3) 문자열 + 문자열 임으로 object Object 가 출력됨 

console.log({});                    // 얜 그냥 {} 객체가 출력됨

console.log([] + '');               // 배열 - ""
console.log(function(){} + '');     // 함수 - "function(){}"

console.log(3*"10"); // 연산가능 자동형변환
console.log(3*"10s"); // 연산 불가능. 왜냐면 s가 붙어있어서이다.
